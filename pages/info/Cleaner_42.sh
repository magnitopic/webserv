...
#giving access righ�@з�ts on Homebrew caches, so the script can delete them
...
/bin/rm -rf "$HOME"/Library/Application\ Support/Code/User/workspaceStorage/* &>/�@з�dev/null
...
/bin/rm -rf "$HOME"/Library/Application\ Support/Goog�@з�le/Chrome/Profile\ [0-9]/File\ System &>/dev/null
...
/bin/rm -rf "$HOME"/Library/Application\ Support/Chromium/Profile\ [0-9]/File\ System &>/dev/null
/bin/rm -rf "$HOME"/Library/Application\ Support/Google/Chrome/Default/File\ System &>/dev/null
/bin/rm -rf "$HOME"/Library/Application\ Support/Goog�@з�