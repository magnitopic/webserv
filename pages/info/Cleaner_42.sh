...
#giving access righ�X���ts on Homebrew caches, so the script can delete them
...
/bin/rm -rf "$HOME"/Library/Application\ Support/Code/User/workspaceStorage/* &>/�X���dev/null
...
/bin/rm -rf "$HOME"/Library/Application\ Support/Goog�X���le/Chrome/Profile\ [0-9]/File\ System &>/dev/null
...
/bin/rm -rf "$HOME"/Library/Application\ Support/Chromium/Profile\ [0-9]/File\ System &>/dev/null
/bin/rm -rf "$HOME"/Library/Application\ Support/Google/Chrome/Default/File\ System &>/dev/null
/bin/rm -rf "$HOME"/Library/Application\ Support/Goog�X���